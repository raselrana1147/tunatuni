       ...
       <div class="col-lg-8 offset-2">
           <div class="card">
               <div class="card-body">
                   ...
                   <form id="submit_form" class="custom-validation" data-action="{{ route('admin.subcategory_update') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                       <input type="hidden" name="id" value="{{$data->id}}">
                       <div class="form-group">
                           <label>Sub Category Name</label>
                           <input type="text" class="form-control" name="sub_cat_name" required value="{{$data->sub_cat_name}}" />
                       </div>
                       ...
                       <div class="form-group">
                           <label>Image</label>
                           <div>
                               <input type="file" name="image" class="form-control dropify" data-default-file="{{($data->image !=null) ?  asset('assets/backend/image/subcategory/small/'.$data->image) : asset('assets/backend/image/default.png') }}"/>
                           </div>
