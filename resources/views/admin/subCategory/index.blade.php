...
@section("title","DPG Admin | Sub Category List")
...
@section("content")
   <div class="row">
       <div class="col-12">
           <div class="card">
               <div class="card-body">
                     <a href="{{ route('admin.subcategory_create') }}" class="btn btn-primary btn-icon float-right"><span class="btn-icon-label"><i class="fas fa-plus mr-2"></i></span>Add New</a>
...
@section('js')
 ...
 <script>
         var table = $("#tables_item").DataTable({
             ...
             ajax: '{{ route('admin.load_subcategory') }}',
             columns: [
                 { data: 'id',name:'id' },
