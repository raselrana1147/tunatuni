                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/assets/images/demos/demo-13/banners/banner-1.jpg')}}" alt="Banner">
                            </a>
                    ...
                    <div class="col-sm-6 col-lg-3 order-lg-last">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/assets/images/demos/demo-13/banners/banner-3.jpg')}}" alt="Banner">
                            </a>
                    ...
                    <div class="col-lg-6">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/assets/images/demos/demo-13/banners/banner-2.jpg')}}" alt="Banner">
                            </a>
