                    ...
                    <div class="owl-carousel owl-simple" data-toggle="owl" 
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/frontend/assets/images/demos/demo-13/blog/post-1.jpg')}}" alt="image desc">
                                </a>
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/frontend/assets/images/demos/demo-13/blog/post-2.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/frontend/assets/images/demos/demo-13/blog/post-3.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/frontend/assets/images/demos/demo-13/blog/post-4.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
