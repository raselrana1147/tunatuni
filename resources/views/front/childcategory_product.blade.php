...
@section('content')
          	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
          		<div class="container">
          			<h1 class="page-title"> {{$childcategory->subcategory->sub_cat_name}} > {{$childcategory->child_cat_name}}</span></h1>
          		</div><!-- End .container -->
          	</div><!-- End .page-header -->
                  ...
                  <div class="container">
                      <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="{{ route('front.index') }}">Home</a></li>
                           <li class="breadcrumb-item"><a href="{{ route('product.childcategory_product',$childcategory->id) }}">Child Category Product</a></li>
                  </div><!-- End .container -->
